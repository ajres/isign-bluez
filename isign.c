...
int enable_advertising(int advertising_interval, char *advertising_uuid, int major_number, int minor_number, int rssi_value)
{
  ...
  scan_data_cp.data[0] = 0x13;
  scan_data_cp.data[1] = 0x09;
  scan_data_cp.data[2] = 0x6A;
  scan_data_cp.data[3] = 0x61;
  scan_data_cp.data[4] = 0x61;
  scan_data_cp.data[5] = 0x6E;
  scan_data_cp.data[6] = 0x65;
  scan_data_cp.data[7] = 0x65;
  scan_data_cp.data[8] = 0x00;
  scan_data_cp.data[9] = 0x00;
  scan_data_cp.data[10] = 0x00;
  scan_data_cp.data[11] = 0x00;
  scan_data_cp.data[12] = 0x00;
  scan_data_cp.data[13] = 0x00;
  scan_data_cp.data[14] = 0x00;
  scan_data_cp.data[15] = 0x00;
  scan_data_cp.data[16] = 0x00;
  scan_data_cp.data[17] = 0x00;
  scan_data_cp.data[18] = 0x00;
  scan_data_cp.data[19] = 0x00;

  scan_data_cp.length = 0x14;
